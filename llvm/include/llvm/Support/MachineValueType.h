...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      v64bf16        =  80,   //   64 x bf16
      v128bf16       =  81,   //  128 x bf16
      v1f32          =  82,   //    1 x f32
      v2f32          =  83,   //    2 x f32
      v3f32          =  84,   //    3 x f32
      v4f32          =  85,   //    4 x f32
      ...
      v32f32         =  89,   //   32 x f32
      v64f32         =  90,   //   64 x f32
      v128f32        =  91,   //  128 x f32
      v256f32        =  92,   //  256 x f32
      v512f32        =  93,   //  512 x f32
      v1024f32       =  94,   // 1024 x f32
      v2048f32       =  95,   // 2048 x f32
      v1f64          =  96,   //    1 x f64
      v2f64          =  97,   //    2 x f64
      v4f64          =  98,   //    4 x f64
      v8f64          = 99,   //    8 x f64
      ...
      nxv1i1         = 102,   // n x  1 x i1
      nxv2i1         = 103,   // n x  2 x i1
      nxv4i1         = 104,   // n x  4 x i1
      nxv8i1         = 105,   // n x  8 x i1
      nxv16i1        = 106,   // n x 16 x i1
      nxv32i1        = 107,   // n x 32 x i1
      nxv64i1        = 108,   // n x  64 x i1
      ...
      nxv1f16        = 134,  // n x   1 x f16
      nxv2f16        = 135,  // n x   2 x f16
      nxv4f16        = 136,  // n x   4 x f16
      nxv8f16        = 137,  // n x   8 x f16
      nxv16f16       = 138,  // n x  16 x f16
      nxv32f16       = 139,  // n x  32 x f16
